...
public class ConstantUtil {
    ...
    //初始化
    public static String APP_ID = "wxb93997d5416a58e1";//微信开发平台应用id
    public static String APP_SECRET = "c4dbc3329c4d161ebe4d75e2080077b2 ";//应用对应的凭证
    //应用对应的密钥
    ...
    public static String PARTNER = "1394437902";//财付通商户号
    public static String PARTNER_KEY = "c4dbc3329c4d161ebe4d75e2080077b2";//商户号对应的密钥
