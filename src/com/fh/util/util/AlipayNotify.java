package com.fh.util.util;

import com.fh.util.Tools;
import com.fh.util.config.AlipayConfig;
import com.fh.util.sign.RSA;
...
public class AlipayNotify {
     ...
     * @return 生成的签名结果
     */
	public static boolean getSignVeryfy(Map<String, String> Params, String sign) throws IOException {
