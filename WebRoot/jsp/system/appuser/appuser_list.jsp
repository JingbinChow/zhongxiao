...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="happuser/listUsers.do?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm" id="userForm">
			<table border='0'>
				<tr>
						...
						<c:forEach items="${userList}" var="user" varStatus="vs">
							...
							<tr>
								<td class='center' style="width: 30px;">
									<label><input type='checkbox' name='ids' value="${user.USER_ID }"/><span class="lbl"></span></label>
								</td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function editUser(user_id){
			 ...
			 diag.Drag=true;
			 diag.Title ="会员资料";
			 diag.URL = 'goEditU.do?USER_ID='+user_id;
			 diag.Width = 450;
			 diag.Height = 355;
			 diag.CancelEvent = function(){ //关闭事件
				diag.close();
		...
		function toExcel(){
			...
			window.location.href='excel.do?USERNAME='+USERNAME+'&lastLoginStart='+lastLoginStart+'&lastLoginEnd='+lastLoginEnd+'&ROLE_ID='+ROLE_ID+'&STATUS='+STATUS;
		}
		</script>
